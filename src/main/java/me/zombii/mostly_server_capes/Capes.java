...
public enum Capes {
    MOJANG_CLASSIC(
            "http://textures.minecraft.net/texture/8f120319222a9f4a104e2f5cb97b2cda93199a2ee9e1585cb8d09d6f687cb761"),
    ...
    MINECON_2012(
            "http://textures.minecraft.net/texture/a2e8d97ec79100e90a75d369d1b3ba81273c4f82bc1b737e934eed4a854be1b6"),
    MINECON_2013(
            "http://textures.minecraft.net/texture/153b1a0dfcbae953cdeb6f2c2bf6bf79943239b1372780da44bcbb29273131da"),
    MINECON_2015(
    ...
    CHEAPSH0T(
            "http://textures.minecraft.net/texture/ca29f5dd9e94fb1748203b92e36b66fda80750c87ebc18d6eafdb0e28cc1d05f"),
    MR_MESSIAH(
            "http://textures.minecraft.net/texture/2e002d5e1758e79ba51d08d92a0f3a95119f2f435ae7704916507b6c565a7da8"),
    PRISMARINE(
    ...
    TRANSLATOR_CHINESE(
            "http://textures.minecraft.net/texture/2262fb1d24912209490586ecae98aca8500df3eff91f2a07da37ee524e7e3cb6"),
    ...
    MOJIRA_MODERATOR(
            "http://textures.minecraft.net/texture/ae677f7d98ac70a533713518416df4452fe5700365c09cf45d0d156ea9396551"),
    ...
    CHRISTMAS_2010(
            "https://minecraft.wiki/images/archive/20200223020907!Christmas_2010_Cape_(texture).png",
            true),
    NEW_YEAR_2011(
    ...
    // Optifine Capes
    OPTIFINE_STANDARD("https://minecraftcapes.net/api/gallery/optifine-capes/standard"),
    OPTIFINE_WHITE("https://minecraftcapes.net/api/gallery/optifine-capes/white"),
    OPTIFINE_GRAY("https://minecraftcapes.net/api/gallery/optifine-capes/gray"),
    OPTIFINE_BLACK("https://minecraftcapes.net/api/gallery/optifine-capes/black"),
    OPTIFINE_RED("https://minecraftcapes.net/api/gallery/optifine-capes/red"),
    OPTIFINE_GREEN("https://minecraftcapes.net/api/gallery/optifine-capes/green"),
    OPTIFINE_BLUE("https://minecraftcapes.net/api/gallery/optifine-capes/blue"),
    OPTIFINE_YELLOW("https://minecraftcapes.net/api/gallery/optifine-capes/yellow"),
    OPTIFINE_PURPLE("https://minecraftcapes.net/api/gallery/optifine-capes/purple"),
    OPTIFINE_CYAN("https://minecraftcapes.net/api/gallery/optifine-capes/cyan"),
    HEAD_CAPE("https://minecraftcapes.net/api/gallery/head-capes/%PLAYER_NAME%/0/0/0/0/1");

    private final String capeURL;
    private final boolean requiresClient;

    Capes(String capeURL) {
        this(capeURL, false);
    }

    Capes(String capeURL, boolean requiresClient) {
